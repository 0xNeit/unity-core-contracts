 ...
 * @author UnityCore
 */
contract ControllerG3 is ControllerV3Storage, ControllerInterfaceG1, ControllerErrorReporter, Exponential {
    ...
    function distributeUAIMinterUcore(address uaiMinter, bool distributeAll) public {
        if (address(uaiVaultAddress) != address(0)) {
            releaseToVault();
        }
     ...
     */
    function _setUcoreUAIVaultRate(uint ucoreUAIVaultRate_) public {
        require(msg.sender == admin, "only admin can");
