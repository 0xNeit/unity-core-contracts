...
import "../Tokens/VTokens/VCORE.sol";
import "./ControllerScenario.sol";

contract VCOREHarness is VCORE {
    ...
    ) public VCORE(controller_, interestRateModel_, initialExchangeRateMantissa, name_, symbol_, decimals_, admin_) {}
...
contract VCOREScenario is VCORE {
